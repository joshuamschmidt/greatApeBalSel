...
#### have to get ens ids for ltvips
...
ens_name <- fread("/Users/joshuaschmidt/Projects/greatApeBalSel/gene_annotations/ltvips_ensIds_gene.names.txt",
                  col.names = c("ens_id","name"))
...
for (htv in ht_names){
  genes[ens_id %in% htvips[,get(htv)]]
}
